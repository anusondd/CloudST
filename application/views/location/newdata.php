<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo  base_url('location'); ?>">คลังสินค้า</a></li>
        ...
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo  base_url('location/postdata'); ?>" method="post">
                ...
                <div class="box-footer">
                    ...
                    <a class="btn btn-danger" href="<?php echo  base_url('location'); ?>" role="button"><i class="fa fa-fw fa-close"></i> ยกเลิก</a>
                </div>
            </form>
        </div>
    </section><!-- /.content -->
