    ...
    <body class="login-page">
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="https://www.facebook.com/herosib">Cloud Store</a> 1.0
            </div><!-- /.login-logo -->
            <div class="login-box-body">

                <img src=" /pictures/Dev.jpg " class="img-responsive" alt="Cinque Terre" width="304" height="236"> 

            	<p class="login-box-msg">เข้าสู่ระบบเพื่อจัดการสต๊อกสินค้า</p>
                ...
                <form method="post" action="<?php echo base_url('user/validlogin') ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                          <a class="btn btn-default btn-block btn-flat" type="submit" href="<?php echo site_url('onhandprint'); ?>">ดูรายงานคลังสินค้า</a>
                        </div>
                    </div>
                </form>

                <a href="https://www.facebook.com/herosib" target="_blank">power by Developer</a>
