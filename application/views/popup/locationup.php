                                                ...
                                                <?php if (!empty($results)) {
                                                    foreach ($results as $data) { ?>
                                                        <tr role="row">
                                                            ...
                                                            <td>
                                                               <a class="btn btn-primary btn-xs" href="#" role="button" onclick="setName('<?php echo $data->id;?>','<?php echo $data->name;?>');"><i class="fa fa-check-square-o"></i> เลือก</a>
                                                            </td>
                                                        </tr>
    <?php }
} ?>
...
<?php echo $link; ?>
        ...
        <script type="text/javascript">
            function setName(location_id, location_name) {
                if (window.opener != null && !window.opener.closed) {
                    var txtlocation_id = window.opener.document.getElementById("location_id");
                    var txtlocation_name = window.opener.document.getElementById("location_name");

                    txtlocation_id.value = location_id;
                    txtlocation_name.value = location_name;
                }
