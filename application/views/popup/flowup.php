                                                ...
                                                if (!empty($results)) {
                                                    foreach ($results as $data) {
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <td>
                                                                <a class="btn btn-primary btn-xs" href="#" role="button" onclick="setName('<?php echo $data->itemname;?>','<?php echo $data->barcode;?>','<?php echo $data->price;?>');"><i class="fa fa-check-square-o"></i> เลือก</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
...
<?php echo $link; ?>
        ...
        <script type="text/javascript">
            function setName(itemname,barcode,price) {
