                                                ...
                                                if (!empty($results)) {
                                                    foreach ($results as $data) {
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <td>
                                                                <a class="btn btn-primary btn-xs" href="#" role="button" onclick="setName('<?php echo $data->id;?>','<?php echo $data->name;?>','<?php echo $data->barcode;?>','<?php echo $data->unit;?>');"><i class="fa fa-check-square-o"></i> เลือก</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
...
<?php echo $link; ?>
        ...
        <script type="text/javascript">
            function setName(item_id,itemname,barcode,unit) {
