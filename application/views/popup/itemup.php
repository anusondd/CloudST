                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 40px">คงเหลือ</th>
                                                    <th class="sorting" tabindex="0"  rowspan="1" colspan="1" style="width: 10%;">คลัง</th>
                                                ...
                                                if (!empty($results)) {
                                                    foreach ($results as $data) {
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <td>
                                                                <a class="btn btn-primary btn-xs" href="#" role="button" onclick="setName('<?php echo $data->itemname;?>','<?php echo $data->barcode;?>','<?php echo $data->price;?>','<?php echo $data->unit;?>');"><i class="fa fa-check-square-o"></i> เลือก</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
...
<?php echo $link; ?>
        ...
        <script type="text/javascript">
            function setName(itemname,barcode,price,count) {
                if (window.opener != null && !window.opener.closed) {
                    ...
                    var txtcount = window.opener.document.getElementById("count");
                    //var txtlocid = window.opener.document.getElementById("location_id");
                    //var txtlocname = window.opener.document.getElementById("location_name");
                    //var txtonqty = window.opener.document.getElementById("onqty");
                    ...
                    //txtlocid.value = location_id;
                    //txtlocname.value = locname;
                    //txtonqty.value = onqty;
                }
                window.opener.document.getElementById("count").focus();
                window.close();
            }
        </script>
    </body>
