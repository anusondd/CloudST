            ...
            <form role="form" action="<?php echo base_url('openflow/Newflow/'.$result->id); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="open_date" class="form-control" name="open_date" value="<?php echo $result->open_date; ?>" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">ชื่อลูกค้า</label> <?php echo $this->session->flashdata('error_open_entry'); ?>
                        <div class="input-group input-group-sm">
                            <input type="text" id="open_entry" class="form-control" name="open_entry" value="<?php echo $result->name_customer; ?>" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="open_id" class="form-control" name="open_id" value="<?php echo $result->id_customer; ?>" >
                    </div>
